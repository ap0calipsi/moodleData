...
class __Mustache_eb7b24660f968a611babc81a3702390e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if (empty($value)) {
            ...
            $buffer .= $indent . '    ';
            $value = $this->resolveValue($context->find('displayvalue'), $context, $indent);
            $buffer .= $value;
            $buffer .= '
';
        }
    ...
    private function sectionAca16629724b93ddfc082bf5d28870b2(Mustache_Context $context, $indent, $value)
    {
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('edithint'), $context, $indent);
...
';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('component'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '" data-itemtype="';
                $value = $this->resolveValue($context->find('itemtype'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '" data-itemid="';
                $value = $this->resolveValue($context->find('itemid'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '"
';
                ...
                $value = $this->resolveValue($context->find('editlabel'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '" data-type="';
                $value = $this->resolveValue($context->find('type'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '" data-options="';
                $value = $this->resolveValue($context->find('options'), $context, $indent);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '">
';
                $buffer .= $indent . '        ';
